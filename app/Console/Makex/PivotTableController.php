...
class {model_name_1}{model_name_2}Controller extends AdminController
{
	public function __construct()
	{
		$this->setModel(\App\Models\{pivot_model_name}::class);
		$this->setMasterModel(\App\Models\{target_model_name}::class);
